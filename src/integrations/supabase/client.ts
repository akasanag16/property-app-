...
// These are the types for all tables in the database for which we need to override client behavior
...
export const supabase = createClient<Database, 'public', TableDefinitions, CustomFunctions>(SUPABASE_URL, SUPABASE_PUBLISHABLE_KEY, {
  auth: {
    persistSession: true,
